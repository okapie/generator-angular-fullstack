...
// Generated on 2016-02-21 using generator-angular-fullstack 3.3.0
'use strict';
...
gulp.task('constant', function() {
	...
	return plugins.ngConstant({
		 name: 'generatorAngularFullstackApp.constants',
		 deps: [],
		 wrap: true,
		 stream: true,
...
gulp.task('default', [
	'styles', 'transpile:client', 'clean:tmp', 'build:client', 'html', 'transpile:server', 'clean:dist', 'build:client', 'copy:extras', 'copy:assets', 'copy:server'
]);